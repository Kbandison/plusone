  ...
  return (
    <form action={act} className="mt-10 flex flex-col gap-6">
      <fieldset className="flex flex-col gap-3">
        <legend className="mb-2 text-[14.5px]">Sign in as</legend>
        {PRESETS.map((preset, index) => (
          ...
          >
            ...
            <span>
              {preset.label}
              <span className="ml-2 text-[13.4px] text-ink-3">{preset.phone}</span>
            </span>
          </label>
        ))}
      </fieldset>
      ...
      <div className="mt-2 border-t border-line pt-6">
        ...
        {resetState.error ? (
          ...
          <p role="status" className="mt-3 text-[13.9px] text-positive">
