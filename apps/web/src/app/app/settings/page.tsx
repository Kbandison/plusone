  ...
  return (
    <main id="main">
      ...
      <section className="mt-10 rounded-xl border border-line-2 bg-surface p-6">
        <h2 className="text-[1.152rem]">{DRAFT_COPY.app.premiumSettingsHeading}</h2>
      ...
      <section className="mt-10 rounded-xl border border-line-2 bg-surface p-6">
        <h2 className="text-[1.152rem]">{DRAFT_COPY.app.inviteSettingsHeading}</h2>
        <p className="mt-3 text-[14.5px] leading-[1.65] text-ink-2">
      ...
      <section className="mt-10 rounded-xl border border-line-2 bg-surface p-6">
        <h2 className="text-[1.152rem]">{DRAFT_COPY.app.signOutHeading}</h2>
        <p className="mt-3 text-[14.5px] leading-[1.65] text-ink-2">{DRAFT_COPY.app.signOutBody}</p>
      ...
      <section className="mt-10 rounded-xl border border-line-2 bg-surface p-6">
        <h2 className="text-[1.152rem]">{DRAFT_COPY.app.blockedHeading}</h2>
        {blocked.length === 0 ? (
          <p className="mt-4 text-[14.5px] text-ink-2">{DRAFT_COPY.app.blockedEmpty}</p>
        ) : (
            ...
            {blocked.map((row) => (
              ...
              >
                <span className="flex flex-col gap-0.5">
                  <span className="text-[14.5px]">{row.display_name}</span>
      ...
      {deletion?.status === "requested" ? (
        <section className="mt-10 rounded-xl border border-critical/40 bg-surface p-6">
          <h2 className="text-[1.152rem]">{DRAFT_COPY.app.deleteHeading}</h2>
