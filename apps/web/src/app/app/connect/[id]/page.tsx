...
export default async function ConnectPage({
  ...
  return (
    <main id="main">
      <h1 className="text-[clamp(1.7rem,5vw,2.1rem)]">{DRAFT_COPY.app.connectHeading}</h1>
      <p className="mt-4 text-[16px] leading-[1.7] text-ink-2">{DRAFT_COPY.app.connectIntro}</p>
