...
export default async function SignInPage({
  ...
  return (
    <main id="main" className="mx-auto w-full max-w-[614.4px] px-6 py-16 sm:py-24">
      <h1 className="text-h2">{DRAFT_COPY.signIn.heading}</h1>
      <p className="mt-4 text-[15.4px] leading-[1.7] text-ink-2">{DRAFT_COPY.signIn.intro}</p>
      ...
      {link === "expired" ? (
        <p role="status" className="mt-6 text-[14.5px] leading-[1.65] text-ink-2">
