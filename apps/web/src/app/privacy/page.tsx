...
export default function PrivacyPage() {
  return (
    <main id="main" className="mx-auto w-full max-w-[612px] px-6 py-16 sm:py-24">
      ...
      <p className="mt-6 text-[15.3px] leading-[1.7] text-ink-2">{PRIVACY_POLICY_INTRO}</p>

      <p className="mt-5 text-[12.6px] text-ink-3">
      ...
      <p className="mt-8 text-[12.2px] text-ink-3">
