    ...
    <div className="mt-10 flex flex-col gap-6">
      ...
      >
        <button
          ...
          className={buttonClass("primary", "w-full sm:w-auto sm:min-w-[201.6px] sm:self-start")}
        >
      ...
      {state.error && state.attemptsLeft > 0 ? (
        <p className="text-[13.4px] text-ink-3">{C.retriesLeft(state.attemptsLeft)}</p>
      ) : null}
...
function ReviewScreen({
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 text-[15.4px] leading-[1.7] text-ink-2">{body}</p>
