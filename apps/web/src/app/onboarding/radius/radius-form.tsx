  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        <label htmlFor={sliderId} className="text-[14.5px]">
          {C.label}
        </label>
      ...
      <p className="max-w-[46ch] text-[13px] leading-[1.6] text-ink-3">{C.locationHint}</p>
      ...
      {outcome === "unknown" ? (
        <p role="status" className="max-w-[46ch] text-[13px] leading-[1.6] text-critical">
          {C.locationUnknown}
        </p>
      ) : null}
