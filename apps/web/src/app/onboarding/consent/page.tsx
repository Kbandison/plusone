...
export default async function ConsentPage() {
  ...
  return (
    <main id="main" className="mx-auto w-full max-w-[576px] px-6 py-16 sm:py-24">
      ...
      <p className="mt-7 text-[15.9px] leading-[1.7] text-ink-2">{COPY.consent.healthData}</p>
      ...
      <p className="mt-6">
        <Link
          ...
          target="_blank"
          rel="noreferrer"
          className="ease-brand text-[14.9px] text-accent underline decoration-line-2 underline-offset-4 transition-colors duration-200 hover:decoration-accent"
        >
