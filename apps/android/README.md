...
**Graphics** — all generated by `pnpm screenshots`, into
`apps/android/store-screenshots/`.

| asset             | size      | file                          |
| ----------------- | --------- | ----------------------------- |
| App icon          | 512×512   | `apps/android/store_icon.png` |
...
`store_icon.png` is the copy Play's listing wants.
