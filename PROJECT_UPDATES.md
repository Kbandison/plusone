...
| 8   | **Block retention.** Decided 2026-08-19: hide the thread from both Inboxes, never delete the rows, reporter reaches their copy from Settings. Unbuilt. Two open questions — whether the _blocked_ member keeps their copy, and how long a hidden thread is retained before a real purge (a §9 question, tied to #2).                 | fast-follow   |
